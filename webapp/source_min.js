...
var Storage={};Storage.VERSION=1;Storage.PATH_VERSION='com.martinmagni.roper/version';Storage.PREFIX='com.martinmagni.roper/data/';Storage.LEGACY_PREFIX='/';Storage.stringToHex=function(str){var hex='';for(var i=0;i<str.length;i++){hex+=str.charCodeAt(i).toString(16)+" ";}
return hex;}
